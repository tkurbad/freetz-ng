...
[ "$FREETZ_TYPE_0300" == "y" -a "$FREETZ_AVM_VERSION_06_2X" == "y" ] && return 0
[ "$FREETZ_TYPE_0450" == "y" -a "$FREETZ_AVM_VERSION_06_5X" == "y" ] && return 0
[ "$FREETZ_TYPE_0540" == "y" -a "$FREETZ_AVM_VERSION_06_5X" == "y" ] && return 0
[ "$FREETZ_TYPE_0546" == "y" -a "$FREETZ_AVM_VERSION_06_5X" == "y" ] && return 0
[ "$FREETZ_TYPE_1750" == "y" ] && return 0
