...
### FritzDect
 * fritzsmart-gateway/
   - deutschland: [FRITZ.Smart_Gateway-07.59-Release.image](https://download.avm.de/fritzdect/fritzsmart-gateway/deutschland/fritz.os/FRITZ.Smart_Gateway-07.59-Release.image)
