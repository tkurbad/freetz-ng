...
### H
  ...
  * **[HarfBuzz (libharfbuzz.so) 8.3.1](harfbuzz.md)<a id='harfbuzz'></a>**<br>
...
### L
  ...
  * **[libdeflate (libdeflate.so) 1.20](libdeflate.md)<a id='libdeflate'></a>**<br>
  ...
  * **[libpng: PNG library (libpng.so) 1.6.42](libpng.md)<a id='libpng'></a>**<br>
  ...
  * **[libxml2 (libxml2.so) 2.12.6](libxml2.md)<a id='libxml2'></a>**<br>
...
### M
  ...
  * **[mbedtls: mbedCrypto (libmbedcrypto.so) 2.7.19/2.28.7](mbedtls.md)<a id='mbedtls'></a>**<br>
...
### P
  ...
  * **[Pango (libpango-1.0.so) 1.52.1](pango.md)<a id='pango'></a>**<br>
