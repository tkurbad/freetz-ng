$(call PKG_INIT_BIN,$(if $(FREETZ_PACKAGE_SUBVERSION_VERSION_ABANDON),1.9.12,1.14.3))
$(PKG)_MAJOR_VERSION:=1
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_HASH_ABANDON:=3c3a15fd73a21ab55556d7c291cf40e25ade1c070294504aa50b4767db1be397
$(PKG)_HASH_CURRENT:=949efd451a09435f7e8573574c71c7b71b194d844890fa49cd61d2262ea1a440
