$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_NZBGET_VERSION_ABANDON),21.1,21.4-rc2))
...
$(PKG)_HASH_CURRENT:=97681697a056fdae2f99b1285e903535091c2e2df7074c670b55cab63db5e9ed
...
$(PKG)_CONFIGURE_OPTIONS += $(if $(FREETZ_TARGET_GCC_4_MAX),--disable-cpp-check,)

$(PKG)_EXTRA_CXXFLAGS := $(if $(FREETZ_TARGET_GCC_4_MAX),-std=c++11)
$(PKG)_EXTRA_CXXFLAGS += -fpermissive
$(PKG)_EXTRA_CXXFLAGS += -fPIC
$(PKG)_EXTRA_LDFLAGS := $(if $(FREETZ_PACKAGE_NZBGET_STATIC),-static)
...
$($(PKG)_BINARY): $(NZBGET_DIR)/.configured
	$(SUBMAKE) -C $(NZBGET_DIR) \
		EXTRA_CXXFLAGS="$(NZBGET_EXTRA_CXXFLAGS)" \
		EXTRA_LDFLAGS="$(NZBGET_EXTRA_LDFLAGS)"
