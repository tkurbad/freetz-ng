$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_STRACE_VERSION_4),4.9,$(if $(FREETZ_PACKAGE_STRACE_VERSION_5),5.0,6.11)))
...
$(PKG)_HASH_6:=83262583a3529f02c3501aa8b8ac772b4cbc03dc934e98bab6e4883626e283a5
