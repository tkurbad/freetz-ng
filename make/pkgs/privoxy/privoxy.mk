...
ifeq ($(strip $(FREETZ_PACKAGE_PRIVOXY_WITH_PCRE_SHARED_V1)),y)
$(PKG)_DEPENDS_ON += pcre
endif

ifeq ($(strip $(FREETZ_PACKAGE_PRIVOXY_WITH_PCRE_SHARED_V2)),y)
...
$(PKG)_REBUILD_SUBOPTS += FREETZ_PACKAGE_PRIVOXY_WITH_PCRE_STATIC_BI
$(PKG)_REBUILD_SUBOPTS += FREETZ_PACKAGE_PRIVOXY_WITH_PCRE_SHARED_V1
$(PKG)_REBUILD_SUBOPTS += FREETZ_PACKAGE_PRIVOXY_WITH_PCRE_SHARED_V2
...
$(PKG)_CONFIGURE_OPTIONS += $(if $(FREETZ_PACKAGE_PRIVOXY_WITH_PCRE_STATIC_BI),--disable-dynamic-pcre,--enable-dynamic-pcre)
$(PKG)_CONFIGURE_OPTIONS += $(if $(FREETZ_PACKAGE_PRIVOXY_WITH_PCRE_SHARED_V1),--disable-pcre2)
$(PKG)_CONFIGURE_OPTIONS += $(if $(FREETZ_PACKAGE_PRIVOXY_WITH_PCRE_SHARED_V2),--enable-pcre2)
