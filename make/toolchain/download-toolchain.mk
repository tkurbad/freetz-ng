...
KERNEL_TOOLCHAIN_SITE:=$(if $(call qstrip,$(FREETZ_REAL_DEVELOPER_ONLY__DLURL)),$(FREETZ_REAL_DEVELOPER_ONLY__DLURL),$(FREETZ_DL_TOOLCHAIN_SITE))
KERNEL_TOOLCHAIN_HASH:=$(call qstrip,$(FREETZ_DL_KERNEL_TOOLCHAIN_HASH))
KERNEL_TOOLCHAIN_VERSION:=$(if $(call qstrip,$(FREETZ_REAL_DEVELOPER_ONLY__DLKTC)),$(call qstrip,$(FREETZ_REAL_DEVELOPER_ONLY__DLKTC)),$(call qstrip,$(FREETZ_DL_KERNEL_TOOLCHAIN_VERSION)))
...
TARGET_TOOLCHAIN_SITE:=$(if $(call qstrip,$(FREETZ_REAL_DEVELOPER_ONLY__DLURL)),$(FREETZ_REAL_DEVELOPER_ONLY__DLURL),$(FREETZ_DL_TOOLCHAIN_SITE))
TARGET_TOOLCHAIN_HASH:=$(call qstrip,$(FREETZ_DL_TARGET_TOOLCHAIN_HASH))
TARGET_TOOLCHAIN_VERSION:=$(if $(call qstrip,$(FREETZ_REAL_DEVELOPER_ONLY__DLTTC)),$(call qstrip,$(FREETZ_REAL_DEVELOPER_ONLY__DLTTC)),$(call qstrip,$(FREETZ_DL_TARGET_TOOLCHAIN_VERSION)))
