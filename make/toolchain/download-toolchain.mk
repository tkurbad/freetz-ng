...
KERNEL_TOOLCHAIN_VERSION:=$(call qstrip,$(if $(call qstrip,$(FREETZ_REAL_DEVELOPER_ONLY__TCDLK)),$(FREETZ_REAL_DEVELOPER_ONLY__TCDLK),$(FREETZ_DL_KERNEL_TOOLCHAIN_VERSION)))
KERNEL_TOOLCHAIN_SOURCE:=$(call qstrip,$(KERNEL_TOOLCHAIN_COMPILER)-freetz-$(KERNEL_TOOLCHAIN_VERSION)-shared-glibc.tar.lzma)
KERNEL_TOOLCHAIN_HASH:=$(call qstrip,$(FREETZ_DL_KERNEL_TOOLCHAIN_HASH))
KERNEL_TOOLCHAIN_SITE:=$(call qstrip,$(if $(call qstrip,$(FREETZ_REAL_DEVELOPER_ONLY__TCURL)),$(FREETZ_REAL_DEVELOPER_ONLY__TCURL),$(FREETZ_DL_KERNEL_TOOLCHAIN_SITE)))

TARGET_TOOLCHAIN_VERSION:=$(call qstrip,$(if $(call qstrip,$(FREETZ_REAL_DEVELOPER_ONLY__TCDLT)),$(FREETZ_REAL_DEVELOPER_ONLY__TCDLT),$(FREETZ_DL_TARGET_TOOLCHAIN_VERSION)))
TARGET_TOOLCHAIN_SOURCE:=$(call qstrip,$(TARGET_TOOLCHAIN_COMPILER)-freetz-$(TARGET_TOOLCHAIN_VERSION)-shared-glibc.tar.lzma)
TARGET_TOOLCHAIN_HASH:=$(call qstrip,$(FREETZ_DL_TARGET_TOOLCHAIN_HASH))
TARGET_TOOLCHAIN_SITE:=$(call qstrip,$(if $(call qstrip,$(FREETZ_REAL_DEVELOPER_ONLY__TCURL)),$(FREETZ_REAL_DEVELOPER_ONLY__TCURL),$(FREETZ_DL_TARGET_TOOLCHAIN_SITE)))
...
$(DL_DIR)/$(KERNEL_TOOLCHAIN_SOURCE): | $(DL_DIR)
	...
	@$(DL_TOOL) $(DL_DIR) $(KERNEL_TOOLCHAIN_SOURCE) $(KERNEL_TOOLCHAIN_SITE) $(KERNEL_TOOLCHAIN_HASH) $(SILENT)

$(DL_DIR)/$(TARGET_TOOLCHAIN_SOURCE): | $(DL_DIR)
	@$(call _ECHO,downloading,$(KERNEL_TOOLCHAIN__ECHO_TYPE),$(TARGET_TOOLCHAIN__ECHO_MAKE))
	@$(DL_TOOL) $(DL_DIR) $(TARGET_TOOLCHAIN_SOURCE) $(TARGET_TOOLCHAIN_SITE) $(TARGET_TOOLCHAIN_HASH) $(SILENT)
